...
#include "Commands/FTDStartCommand.h"
#include "Commands/FTDStopCommand.h"
#include "Commands/FTDReadCommand.h"
#include "Commands/FTDWriteCommand.h"
#include "Commands/FTDSamplesCommand.h"
#include "Commands/FTDReadFileCommand.h"
#include "Commands/FTDWriteFileCommand.h"
#include "Commands/FTDScopeCommand.h"
#include <fstream>
#include <sstream>
#include <iostream>
#include <algorithm>
...
std::unique_ptr<FTDCommand> FTDCommandParser::parseCommand(const std::string& line) {
    ...
    if (command == "start") {
        return std::make_unique<FTDStartCommand>();
    }
    else if (command == "stop") {
        return std::make_unique<FTDStopCommand>();
    }
        ...
        return std::make_unique<FTDReadCommand>(count);
    }
        ...
        return std::make_unique<FTDWriteCommand>(byteValue, count);
    }
...
std::unique_ptr<FTDCommand> FTDCommandParser::parseScopeCommand(const std::vector<std::string>& tokens) {
    ...
    return std::make_unique<FTDScopeCommand>(sampleIntervalMicros, waitTimeMicros);
}
